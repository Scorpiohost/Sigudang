                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header border-0">
                            <div class="row">
                                <div class="col-10">
                                    <h3 class="mb-0 col">Pengguna</h3>
                                </div>
                                <div class="col-2">
                                    <a href="<?= base_url() ?>pengguna/tambah" class="btn btn-sm btn-primary col">Tambah data</a>
                                </div>
                            </div>
                        </div>
                        <!-- Light table -->
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="media align-items-center">
                                                    <a href="#" class="avatar rounded-circle mr-3">
                                                        <img alt="Image placeholder" src="<?= base_url() ?>/assets/img/theme/default.jpg">
                                                    </a>
                                            ...
                                            <td>
                                                <span class="badge badge-dot mr-4">
                                                    <a href="<?= base_url()?>pengguna/hapus/<?= $data->id ?>" class="btn btn-sm btn-danger hapus">Hapus</a>
                                                </span>
                                            </td>
                                        </tr>
                                        <?php endforeach ?>
