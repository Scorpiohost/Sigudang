                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="combobox">
                                        <select class="form-select" id="barang" name="barang" value="<?= set_value('barang') ?>" aria-describedby="emailHelp">
                                            <?php if ($barang != null) : ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="date" name="date" value="<?= set_value('date') ?>" aria-describedby="emailHelp">
                                    <?= form_error('date') ?>
                                </div>
                                <div class="button">
